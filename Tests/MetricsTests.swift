...
//               "menu bar metric order migrates the old generic temperature value")
        ...
        let writeChecksum: UInt8 = [0x6E, 0x51, 0x84, 0x03, 0x10, 0x12, 0x34].reduce(0, ^)
        let expectedDdcWrite: [UInt8] = [0x84, 0x03, 0x10, 0x12, 0x34, writeChecksum]
        ...
        let readChecksum: UInt8 = [0x6E, 0x82, 0x01, 0x10].reduce(0, ^)
        let expectedDdcRead: [UInt8] = [0x82, 0x01, 0x10, readChecksum]
