...
extension MonitorAlertFeatureStrings {
    static let ko = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "시스템 설정에서 RyzenStatus 알림이 꺼져 있어 경고를 표시할 수 없습니다.",
        cpu: "높은 CPU 사용량",
...
struct MonitorAlertFeatureStrings {
    ...
    static let enUS = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Notifications for RyzenStatus are off in System Settings, so alerts cannot appear.",
        cpu: "High CPU",
    ...
    static let ptBR = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "As notificações do RyzenStatus estão desativadas nos Ajustes do Sistema, então os alertas não aparecem.",
        cpu: "CPU alta",
    ...
    static let tr = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Sistem Ayarları'nda RyzenStatus bildirimleri kapalı, bu yüzden uyarılar görünemez.",
        cpu: "Yüksek CPU",
    ...
    static let ru = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Уведомления RyzenStatus выключены в Системных настройках, поэтому оповещения не появятся.",
    ...
    static let es = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Las notificaciones de RyzenStatus están desactivadas en Ajustes del Sistema, así que las alertas no aparecen.",
        cpu: "CPU alta",
    ...
    static let de = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Mitteilungen für RyzenStatus sind in den Systemeinstellungen aus, daher können keine Warnungen erscheinen.",
        cpu: "Hohe CPU",
    ...
    static let fr = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Les notifications de RyzenStatus sont désactivées dans Réglages Système, les alertes ne peuvent donc pas apparaître.",
        cpu: "CPU élevé",
    ...
    static let it = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Le notifiche di RyzenStatus sono disattivate in Impostazioni di Sistema, quindi gli avvisi non compaiono.",
        cpu: "CPU alta",
    ...
    static let ja = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "システム設定でRyzenStatusの通知がオフのため、アラートは表示されません。",
        cpu: "CPU 高負荷",
    ...
    static let zhHans = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "RyzenStatus 的通知已在系统设置中关闭，警报无法显示。",
        cpu: "CPU 过高",
    ...
    static let zhTW = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "RyzenStatus 的通知已在系統設定中關閉，警示無法顯示。",
        cpu: "CPU 使用率過高",
