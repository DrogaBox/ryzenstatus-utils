...
struct ClipboardFeatureStrings {
    ...
    static let it = ClipboardFeatureStrings(
        ...
        localNote: "Tutto resta su questo Mac. Gli elementos molto grandi vengono ignorati.",
...
public struct PerformanceSuiteFeatureStrings {
    ...
    public let cpuUtilization: String
    public let cpuTotal: String
    public let memoryFootprint: String
    public let networkIO: String
    public let diskActivity: String
    public let powerDraw: String
    public let battery: String
    public let insightsTitle: String
    public let insightsSubtitle: String
    public let filterAll: String
    public let noInsights: String
    public let noInsightsSubtitle: String
    public let analyticsTitle: String
    public let analyticsSubtitle: String
    public let energyTitle: String
    public let energySubtitle: String
    public let networkTitle: String
    public let networkSubtitle: String
    public let noNetworkAdapters: String
    public let pidColumn: String
    public let processColumn: String
    public let typeColumn: String
    public let cpuColumn: String
    public let memoryColumn: String
    public let energyScoreColumn: String
    public let rxColumn: String
    public let txColumn: String
    public let actionColumn: String
    public let inspectButton: String
    public let killButton: String
    public let killConfirmTitle: String
    public let killConfirmMessage: String
    public let killCancel: String
    public let threadsTitle: String
}
...
extension PerformanceSuiteFeatureStrings {
    static let enUS = PerformanceSuiteFeatureStrings(
        ...
        cpuTotal: "CPU Total",
        memoryFootprint: "RAM Used",
        networkIO: "Network Throughput",
        diskActivity: "Disk Activity",
        powerDraw: "Power Draw",
        battery: "Battery",
        insightsTitle: "Diagnostic Insights",
        insightsSubtitle: "Automated diagnostic engine analyzing runtime health and anomalies.",
        filterAll: "All",
        noInsights: "No Active Diagnostic Findings",
        noInsightsSubtitle: "System is performing optimally with no memory leaks or abnormal resource consumption.",
        analyticsTitle: "Telemetry Analytics",
        analyticsSubtitle: "Live multi-metric charts across CPU, GPU, memory and thermal sensors.",
        energyTitle: "Process Energy Impact",
        energySubtitle: "Calculated power draw impact based on CPU and GPU utilization.",
        networkTitle: "Network Adapters & Traffic",
        networkSubtitle: "Active network interfaces and live data transmission rates.",
        noNetworkAdapters: "No Active Network Adapters",
        pidColumn: "PID",
        processColumn: "Process",
        typeColumn: "Type",
        cpuColumn: "CPU %",
        memoryColumn: "Memory",
        energyScoreColumn: "Energy Score",
        rxColumn: "Down",
        txColumn: "Up",
        actionColumn: "Action",
        inspectButton: "Inspect",
        killButton: "Terminate Process",
        killConfirmTitle: "Terminate Process",
        killConfirmMessage: "Are you sure you want to terminate %@ (PID %d)?",
        killCancel: "Cancel",
    ...
    static let ptBR = PerformanceSuiteFeatureStrings(
        title: "RyzenStatus Performance Suite",
        dashboardTab: "Painel",
        insightsTab: "Diagnósticos",
        analyticsTab: "Análises",
        energyTab: "Energia",
        networkTab: "Rede",
        cpuUtilization: "Uso de CPU",
        cpuTotal: "CPU Total",
        memoryFootprint: "RAM Usada",
        networkIO: "Taxa de Rede",
        diskActivity: "Atividade de Disco",
        powerDraw: "Consumo de Energia",
        battery: "Bateria",
        insightsTitle: "Diagnósticos do Sistema",
        insightsSubtitle: "Motor de diagnóstico automático para anomalias de desempenho.",
        filterAll: "Todos",
        noInsights: "Nenhum Problema Detectado",
        noInsightsSubtitle: "O sistema está operando normalmente sem vazamentos ou sobrecargas.",
        analyticsTitle: "Análise de Telemetria",
        analyticsSubtitle: "Gráficos de telemetria em tempo real para processador, memória e sensores.",
        energyTitle: "Impacto Energético dos Processos",
        energySubtitle: "Cálculo de impacto energético baseado em CPU e GPU.",
        networkTitle: "Adaptadores de Rede e Tráfego",
        networkSubtitle: "Interfaces ativas e taxas reais de transmissão de dados.",
        noNetworkAdapters: "Nenhum Adaptador de Rede Ativo",
        pidColumn: "PID",
        processColumn: "Processo",
        typeColumn: "Tipo",
        cpuColumn: "CPU %",
        memoryColumn: "Memória",
        energyScoreColumn: "Pontuação",
        rxColumn: "Download",
        txColumn: "Upload",
        actionColumn: "Ação",
        inspectButton: "Inspecionar",
        killButton: "Encerrar Processo",
        killConfirmTitle: "Encerrar Processo",
        killConfirmMessage: "Tem certeza de que deseja encerrar %@ (PID %d)?",
        killCancel: "Cancelar",
        threadsTitle: "Threads"
    )
    static let es = PerformanceSuiteFeatureStrings(
        ...
        cpuTotal: "CPU Total",
        memoryFootprint: "RAM Usada",
        networkIO: "Rendimiento de Red",
        diskActivity: "Actividad de Disco",
        powerDraw: "Consumo de Energía",
        battery: "Batería",
        insightsTitle: "Diagnósticos del Sistema",
        insightsSubtitle: "Motor de diagnóstico automático para salud y anomalías en tiempo de ejecución.",
        filterAll: "Todos",
        noInsights: "Sin Anomalías Detectadas",
        noInsightsSubtitle: "El sistema rinde óptimamente sin fugas de memoria ni sobrecargas.",
        analyticsTitle: "Analítica de Telemetría",
        analyticsSubtitle: "Gráficas de telemetría en tiempo real de procesador, memoria y sensores.",
        energyTitle: "Impacto Energético de Procesos",
        energySubtitle: "Impacto estimado según consumo de CPU y GPU por proceso.",
        networkTitle: "Adaptadores de Red y Tráfico",
        networkSubtitle: "Interfaces activas y tasas reales de transmisión de datos.",
        noNetworkAdapters: "Sin Adaptadores de Red Activos",
        pidColumn: "PID",
        processColumn: "Proceso",
        typeColumn: "Tipo",
        cpuColumn: "CPU %",
        memoryColumn: "Memoria",
        energyScoreColumn: "Puntuación",
        rxColumn: "Bajada",
        txColumn: "Subida",
        actionColumn: "Acción",
        inspectButton: "Inspeccionar",
        killButton: "Terminar Proceso",
        killConfirmTitle: "Terminar Proceso",
        killConfirmMessage: "¿Seguro que deseas forzar la finalización de %@ (PID %d)?",
        killCancel: "Cancelar",
        threadsTitle: "Hilos"
    )
    static let de = PerformanceSuiteFeatureStrings(
        ...
        cpuTotal: "CPU Gesamt",
        memoryFootprint: "RAM Belegt",
        networkIO: "Netzwerkdurchsatz",
        diskActivity: "Festplattenaktivität",
        powerDraw: "Leistungsaufnahme",
        battery: "Batterie",
        insightsTitle: "Systemdiagnose",
        insightsSubtitle: "Automatische Diagnose zur Erkennung von Leistungsanomalien.",
        filterAll: "Alle",
        noInsights: "Keine Auffälligkeiten Gefunden",
        noInsightsSubtitle: "Das System läuft optimal ohne Speicherlecks oder übermäßige Last.",
        analyticsTitle: "Telemetrie-Analysen",
        analyticsSubtitle: "Echtzeit-Diagramme für Prozessor, Speicher und Sensoren.",
        energyTitle: "Energieeinfluss von Prozessen",
        energySubtitle: "Berechneter Energiebedarf basierend auf CPU- und GPU-Nutzung.",
        networkTitle: "Netzwerkadapter & Datenverkehr",
        networkSubtitle: "Aktive Schnittstellen und reale Übertragungsraten.",
        noNetworkAdapters: "Keine aktiven Netzwerkadapter",
        pidColumn: "PID",
        processColumn: "Prozess",
        typeColumn: "Typ",
        cpuColumn: "CPU %",
        memoryColumn: "Speicher",
        energyScoreColumn: "Energie-Wert",
        rxColumn: "Down",
        txColumn: "Up",
        actionColumn: "Aktion",
        inspectButton: "Prüfen",
        killButton: "Prozess beenden",
        killConfirmTitle: "Prozess beenden",
        killConfirmMessage: "Möchtest du %@ (PID %d) wirklich beenden?",
        killCancel: "Abbrechen",
        threadsTitle: "Threads"
    )
    static let fr = PerformanceSuiteFeatureStrings(
        ...
        cpuTotal: "CPU Total",
        memoryFootprint: "RAM Utilisée",
        networkIO: "Débit Réseau",
        diskActivity: "Activité Disque",
        powerDraw: "Consommation Électrique",
        battery: "Batterie",
        insightsTitle: "Diagnostics Système",
        insightsSubtitle: "Moteur de diagnostic automatique des performances et anomalies.",
        filterAll: "Tous",
        noInsights: "Aucune Anomalie Détectée",
        noInsightsSubtitle: "Le système fonctionne de manière optimale sans fuite de mémoire.",
        analyticsTitle: "Analytique Télémétrique",
        analyticsSubtitle: "Graphiques en direct pour processeur, mémoire et capteurs.",
        energyTitle: "Impact Énergétique des Processus",
        energySubtitle: "Calcul de l'impact énergétique basé sur CPU et GPU.",
        networkTitle: "Adaptateurs Réseau & Trafic",
        networkSubtitle: "Interfaces actives et débits de transmission en direct.",
        noNetworkAdapters: "Aucun Adaptateur Réseau Actif",
        pidColumn: "PID",
        processColumn: "Processus",
        typeColumn: "Type",
        cpuColumn: "CPU %",
        memoryColumn: "Mémoire",
        energyScoreColumn: "Score Énergie",
        rxColumn: "Descendant",
        txColumn: "Ascendant",
        actionColumn: "Action",
        inspectButton: "Inspecter",
        killButton: "Terminer le processus",
        killConfirmTitle: "Terminer le processus",
        killConfirmMessage: "Voulez-vous vraiment terminer %@ (PID %d) ?",
        killCancel: "Annuler",
        threadsTitle: "Threads"
    )
    static let it = PerformanceSuiteFeatureStrings(
        title: "RyzenStatus Performance Suite",
        dashboardTab: "Dashboard",
        insightsTab: "Diagnostica",
        analyticsTab: "Analitica",
        energyTab: "Energia",
        networkTab: "Rete",
        cpuUtilization: "Utilizzo CPU",
        cpuTotal: "CPU Totale",
        memoryFootprint: "RAM Usata",
        networkIO: "Throughput di Rete",
        diskActivity: "Attività Disco",
        powerDraw: "Consumo Energetico",
        battery: "Batteria",
        insightsTitle: "Diagnostica di Sistema",
        insightsSubtitle: "Motore di diagnosi automatica per anomalie di prestazioni.",
        filterAll: "Tutti",
        noInsights: "Nessuna Anomalia Rilevata",
        noInsightsSubtitle: "Il sistema opera in modo ottimale senza perdite di memoria.",
        analyticsTitle: "Analitica Telemetria",
        analyticsSubtitle: "Grafici in tempo reale per CPU, memoria e sensori.",
        energyTitle: "Impatto Energetico dei Processi",
        energySubtitle: "Calcolo dell'impatto energetico su CPU e GPU.",
        networkTitle: "Schede di Rete e Traffico",
        networkSubtitle: "Interfacce attive e velocità di trasmissione reali.",
        noNetworkAdapters: "Nessuna Scheda di Rete Attiva",
        pidColumn: "PID",
        processColumn: "Processo",
        typeColumn: "Tipo",
        cpuColumn: "CPU %",
        memoryColumn: "Memoria",
        energyScoreColumn: "Punteggio",
        rxColumn: "Down",
        txColumn: "Up",
        actionColumn: "Azione",
        inspectButton: "Ispeziona",
        killButton: "Termina Processo",
        killConfirmTitle: "Termina Processo",
        killConfirmMessage: "Sei sicuro di voler terminare %@ (PID %d)?",
        killCancel: "Annulla",
        threadsTitle: "Thread"
    )
    static let ja = PerformanceSuiteFeatureStrings(
        ...
        cpuTotal: "CPU 合計",
        memoryFootprint: "使用中メモリ",
        networkIO: "ネットワーク転送速度",
        diskActivity: "ディスクアクセス",
        powerDraw: "消費電力",
        battery: "バッテリー",
        insightsTitle: "システム診断",
        insightsSubtitle: "異常やメモリリークを自動検出する診断エンジン。",
        filterAll: "すべて",
        noInsights: "検出された異常はありません",
        noInsightsSubtitle: "システムは安定して正常に稼働しています。",
        analyticsTitle: "テレメトリー分析",
        analyticsSubtitle: "プロセッサ、メモリ、温度のリアルタイムグラフ。",
        energyTitle: "プロセスのエネルギー影響",
        energySubtitle: "CPUおよびGPU使用率に基づくエネルギー消費スコア。",
        networkTitle: "ネットワークアダプタとトラフィック",
        networkSubtitle: "アクティブなインターフェースと送受信速度。",
        noNetworkAdapters: "アクティブなネットワークアダプタはありません",
        pidColumn: "PID",
        processColumn: "プロセス",
        typeColumn: "種別",
        cpuColumn: "CPU %",
        memoryColumn: "メモリ",
        energyScoreColumn: "エネルギー",
        rxColumn: "受信",
        txColumn: "送信",
        actionColumn: "操作",
        inspectButton: "検査",
        killButton: "プロセスを強制終了",
        killConfirmTitle: "プロセスを強制終了",
        killConfirmMessage: "%@ (PID %d) を強制終了してもよろしいですか？",
        killCancel: "キャンセル",
        threadsTitle: "スレッド"
    )
    static let ko = PerformanceSuiteFeatureStrings(
        ...
        energyTab: "에너지",
        networkTab: "네트워크",
        cpuUtilization: "CPU 사용량",
        cpuTotal: "CPU 전체",
        memoryFootprint: "사용 중인 RAM",
        networkIO: "네트워크 처리량",
        diskActivity: "디스크 활동",
        powerDraw: "전력 소비",
        battery: "배터리",
        insightsTitle: "시스템 진단",
        insightsSubtitle: "이상 징후와 메모리 누수를 감지하는 자동 진단 엔진.",
        filterAll: "전체",
        noInsights: "감지된 진단 항목 없음",
        noInsightsSubtitle: "시스템이 메모리 누수 없이 안정적으로 실행 중입니다.",
        analyticsTitle: "원격 측정 분석",
        analyticsSubtitle: "CPU, GPU, 메모리 및 온도 센서의 실시간 차트.",
        energyTitle: "프로세스 에너지 영향",
        energySubtitle: "CPU 및 GPU 사용률을 기반으로 계산된 에너지 영향도.",
        networkTitle: "네트워크 어댑터 및 트래픽",
        networkSubtitle: "활성 인터페이스 및 실시간 데이터 전송 속도.",
        noNetworkAdapters: "활성 네트워크 어댑터 없음",
        pidColumn: "PID",
        processColumn: "프로세스",
        typeColumn: "유형",
        cpuColumn: "CPU %",
        memoryColumn: "메모리",
        energyScoreColumn: "에너지 점수",
        rxColumn: "다운로드",
        txColumn: "업로드",
        actionColumn: "작업",
        inspectButton: "검사",
        killButton: "프로세스 종료",
        killConfirmTitle: "프로세스 종료",
        killConfirmMessage: "%@ (PID %d) 프로세스를 종료하시겠습니까?",
        killCancel: "취소",
        threadsTitle: "스레드"
    )
    static let zhHans = PerformanceSuiteFeatureStrings(
        title: "RyzenStatus 性能控制中心",
        dashboardTab: "仪表盘",
        insightsTab: "诊断",
        analyticsTab: "数据分析",
        energyTab: "能耗",
        ...
        cpuTotal: "CPU 总计",
        memoryFootprint: "已用内存",
        networkIO: "网络吞吐率",
        diskActivity: "磁盘读写",
        powerDraw: "功耗",
        battery: "电池",
        insightsTitle: "系统健康诊断",
        insightsSubtitle: "自动诊断引擎实时检测资源泄漏与异常负荷。",
        filterAll: "全部",
        noInsights: "未发现异常诊断项",
        noInsightsSubtitle: "系统运行平稳，未发现内存泄漏或高负荷异常。",
        analyticsTitle: "实时遥测分析",
        analyticsSubtitle: "处理器、内存与温度传感器的实时监测图表。",
        energyTitle: "进程能耗影响",
        energySubtitle: "综合 CPU 与 GPU 占用计算得出的能耗影响值。",
        networkTitle: "网络接口与流量",
        networkSubtitle: "当前活动网络适配器及真实数据传输速率。",
        noNetworkAdapters: "未找到活动的网络适配器",
        pidColumn: "PID",
        processColumn: "进程",
        typeColumn: "类型",
        cpuColumn: "CPU %",
        memoryColumn: "内存",
        energyScoreColumn: "能耗分值",
        rxColumn: "下行",
        txColumn: "上行",
        actionColumn: "操作",
        inspectButton: "检查",
        ...
        killConfirmMessage: "确定要强制终止 %@ (PID %d) 吗？",
        killCancel: "取消",
        threadsTitle: "线程"
    )
    static let zhTW = PerformanceSuiteFeatureStrings(
        title: "RyzenStatus 效能控制中心",
        dashboardTab: "儀表板",
        insightsTab: "診斷",
        analyticsTab: "數據分析",
        energyTab: "能耗",
        ...
        cpuUtilization: "CPU 使用率",
        cpuTotal: "CPU 總計",
        memoryFootprint: "已用記憶體",
        networkIO: "網路吞吐量",
        diskActivity: "磁碟讀寫",
        powerDraw: "功耗",
        battery: "電池",
        insightsTitle: "系統健康診斷",
        insightsSubtitle: "自動診斷引擎即時偵測資源流失與異常負載。",
        filterAll: "全部",
        noInsights: "未發現異常診斷項目",
        noInsightsSubtitle: "系統運作平穩，未發現記憶體流失或高負載異常。",
        analyticsTitle: "即時遙測分析",
        analyticsSubtitle: "處理器、記憶體與溫度感應器的即時監測圖表。",
        energyTitle: "程序能耗影響",
        energySubtitle: "綜合 CPU 與 GPU 佔用計算出的能耗影響值。",
        networkTitle: "網路介面與流量",
        networkSubtitle: "目前活動網路配接卡及真實數據傳輸速率。",
        noNetworkAdapters: "未找到活動的網路配接卡",
        pidColumn: "PID",
        processColumn: "程序",
        typeColumn: "類型",
        cpuColumn: "CPU %",
        ...
        killConfirmMessage: "確定要強制終止 %@ (PID %d) 嗎？",
        killCancel: "取消",
        threadsTitle: "執行緒"
    )
    static let zhHK = PerformanceSuiteFeatureStrings(
        ...
        energyTitle: "程序能耗影響",
        energySubtitle: "綜合 CPU 與 GPU 佔用計算出的能耗影響值。",
        networkTitle: "網絡介面與流量",
        networkSubtitle: "目前活動網絡介面卡及真實數據傳輸速率。",
        noNetworkAdapters: "未找到活動的網絡介面卡",
        pidColumn: "PID",
        processColumn: "程序",
        typeColumn: "類型",
        cpuColumn: "CPU %",
    ...
    static let tr = PerformanceSuiteFeatureStrings(
        title: "RyzenStatus Performans Merkezi",
        dashboardTab: "Gösterge Paneli",
        insightsTab: "Tanılama",
        analyticsTab: "Analitik",
        energyTab: "Enerji",
        networkTab: "Ağ",
        cpuUtilization: "İşlemci Kullanımı",
        cpuTotal: "İşlemci Toplam",
        memoryFootprint: "Kullanılan Bellek",
        networkIO: "Ağ Veri Akışı",
        diskActivity: "Disk Aktivitesi",
        powerDraw: "Güç Tüketimi",
        battery: "Pil",
        insightsTitle: "Sistem Tanılamaları",
        insightsSubtitle: "Performans anomalilerini ve sızıntıları algılayan otomatik tanı motoru.",
        filterAll: "Tümü",
        noInsights: "Aktif Tanılama Kaydı Yok",
        noInsightsSubtitle: "Sistem bellek sızıntısı veya aşırı yük olmadan kararlı çalışıyor.",
        analyticsTitle: "Telemetri Analitiği",
        analyticsSubtitle: "İşlemci, bellek ve sıcaklık sensörleri için canlı grafikler.",
        energyTitle: "İşlem Enerji Etkisi",
        energySubtitle: "CPU ve GPU kullanımına göre hesaplanan tahmini enerji puanı.",
        networkTitle: "Ağ Bağdaştırıcıları & Trafik",
        networkSubtitle: "Etkin arayüzler ve gerçek veri aktarım hızları.",
        noNetworkAdapters: "Etkin Ağ Bağdaştırıcısı Bulunamadı",
        pidColumn: "PID",
        processColumn: "İşlem",
        typeColumn: "Tür",
        cpuColumn: "CPU %",
        memoryColumn: "Bellek",
        energyScoreColumn: "Enerji Puanı",
        rxColumn: "İndirme",
        txColumn: "Yükleme",
        actionColumn: "Eylem",
        inspectButton: "İncele",
        killButton: "İşlemi Sonlandır",
        killConfirmTitle: "İşlemi Sonlandır",
        killConfirmMessage: "%@ (PID %d) işlemini sonlandırmak istediğinizden emin misiniz?",
        killCancel: "İptal",
        threadsTitle: "İş Parçacıkları"
    )
    static let ru = PerformanceSuiteFeatureStrings(
        title: "RyzenStatus Панель Производительности",
        dashboardTab: "Панель",
        ...
        cpuTotal: "CPU Всего",
        memoryFootprint: "Память занято",
        networkIO: "Сетевой трафик",
        diskActivity: "Активность диска",
        powerDraw: "Энергопотребление",
        battery: "Батарея",
        insightsTitle: "Системная диагностика",
        insightsSubtitle: "Автоматический анализ аномалий и утечек ресурсов.",
        filterAll: "Все",
        noInsights: "Проблем не обнаружено",
        noInsightsSubtitle: "Система работает стабильно без утечек памяти и перегрузок.",
        analyticsTitle: "Телеметрия и аналитика",
        analyticsSubtitle: "Графики в реальном времени для процессора, памяти и датчиков.",
        energyTitle: "Энергопотребление процессов",
        energySubtitle: "Расчетная оценка энергозатрат на основе CPU и GPU.",
        networkTitle: "Сетевые адаптеры и трафик",
        networkSubtitle: "Активные интерфейсы и реальная скорость передачи данных.",
        noNetworkAdapters: "Нет активных сетевых адаптеров",
        pidColumn: "PID",
        processColumn: "Процесс",
        typeColumn: "Тип",
        cpuColumn: "CPU %",
        memoryColumn: "Память",
        energyScoreColumn: "Энергия",
        rxColumn: "Входящий",
        txColumn: "Исходящий",
        actionColumn: "Действие",
        inspectButton: "Инфо",
        killButton: "Завершить процесс",
        killConfirmTitle: "Завершить процесс",
        killConfirmMessage: "Вы действительно хотите завершить %@ (PID %d)?",
        killCancel: "Отмена",
        threadsTitle: "Потоки"
    )
}
