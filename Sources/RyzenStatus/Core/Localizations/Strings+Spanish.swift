...
extension Strings {
    static let es = Strings(
        statusIdleTooltip: "RyzenStatus: reposo normal",
        statusActiveUntil: "RyzenStatus: activo hasta",
        statusActiveIndefinite: "RyzenStatus: activo indefinidamente",
        menuEnableAwake: "Activar mantener activo",
        menuDisableAwake: "Desactivar mantener activo",
        menuActivateFor: "Activar durante…",
        menuSettings: "Ajustes…",
        menuAbout: "Acerca de RyzenStatus",
        menuQuit: "Salir de RyzenStatus",
        menuHide: "Ocultar RyzenStatus",
        ...
        notifyBatteryTitle: "RyzenStatus desactivado",
        notifyBatteryBody: "Batería baja. Se restauró el reposo normal para proteger la carga.",
        adminPromptClamshellOn: "RyzenStatus necesita tu contraseña para seguir con la tapa cerrada.",
        adminPromptClamshellOff: "RyzenStatus necesita tu contraseña para restaurar el reposo normal del Mac.",
        adminPromptRecover: "RyzenStatus se cerró mientras el reposo del Mac estaba desactivado. Introduce la contraseña para restaurar el reposo normal.",
        adminPromptUpdate: "RyzenStatus necesita tu contraseña para instalar la actualización.",
        adminPromptSudoersInstall: "RyzenStatus creará una regla restringida (solo pmset disablesleep) para alternar el modo de tapa cerrada sin pedir contraseña. Esta es la única vez que se necesita la contraseña.",
        adminPromptSudoersRemove: "RyzenStatus eliminará la regla de tapa cerrada sin contraseña.",

        settingsTitle: "Ajustes de RyzenStatus",
        tabGeneral: "General",
        tabEnergy: "Energía",
        ...
        advancedResetDescription: "Elimina todos los permisos que concediste a RyzenStatus (Accesibilidad, Grabación de pantalla, Acceso total al disco y otros), el ítem de inicio de sesión y la regla de tapa cerrada. Útil para empezar de cero o antes de desinstalar. La app sigue instalada.",
        ...
        advancedUninstallDescription: "Hace todo lo anterior y, además, elimina las preferencias y mueve RyzenStatus a la Papelera, sin dejar rastro. La app se cierra al terminar. Puedes reinstalarla cuando quieras.",
        advancedUninstallButton: "Desinstalar RyzenStatus por completo",
        advancedUninstallConfirmTitle: "¿Desinstalar RyzenStatus?",
        advancedUninstallConfirmBody: "RyzenStatus borrará sus permisos, eliminará sus preferencias y se moverá a la Papelera; después se cerrará. Esto no se puede deshacer desde la app, pero permanece en la Papelera hasta que la vacíes.",
        ...
        keepAwakeAutoStart: "Mantener activo al abrir RyzenStatus",
        ...
        switcherEnable: "Usar el selector de RyzenStatus",
        ...
        uninstallerFDAHint: "Activa RyzenStatus en la lista. Si no aparece, haz clic en + y elige RyzenStatus en Aplicaciones. El acceso solo se aplica después de volver a abrir la app.",
        ...
        switcherNoOpenWindow: "Ninguna ventana abierta",
        ...
        homebrewMissingBody: "RyzenStatus puede abrir Terminal con el instalador oficial de Homebrew. Terminal muestra los pasos y pide tu contraseña si hace falta.",
        ...
        homebrewShellSetupBody: "Homebrew está instalado, pero Terminal quizá aún no encuentre el comando brew. RyzenStatus puede abrir Terminal con el comando de configuración.",
        ...
        homebrewSourceBuildWarning: "Compilando desde el código fuente: esto puede tardar horas en este Mac.",
        homebrewSkipHeavyFormulas: "Omitir fórmulas pesadas (node, llvm, etc.)",
        homebrewSkipHeavyFormulasFootnote: "Evita compilaciones de horas: las fórmulas sin botella quedan desactualizadas.",
        ...
        homebrewTerminalFallback: "Esta operación necesita Terminal para pedir la contraseña de administrador. RyzenStatus no captura contraseñas.",
        ...
        detachedNoticeTitle: "Panel Desacoplado",
        ...
        cpuFrequencyMetricTitle: "Frecuencia CPU (2-Line Peak/Avg)",
        amdRyzenProcessorInfo: "Información del Procesador AMD Ryzen",
        amdMinFrequency: "Frecuencia Mínima",
        amdMaxFrequency: "Frecuencia Máxima (Peak)",
        amdAvgFrequency: "Frecuencia Promedio",
        ...
        updateNotifyTitle: "Actualización de RyzenStatus",
        ...
        updateNeedsApplicationsTitle: "Mueve RyzenStatus a Aplicaciones",
        updateNeedsApplicationsBody: "La app se está ejecutando desde un lugar que no se puede actualizar, como la imagen de disco o una ubicación temporal del sistema. Arrastra RyzenStatus a la carpeta Aplicaciones, ábrela desde ahí y vuelve a intentarlo.",
        ...
        obStart: "Abrir RyzenStatus",
        obStepWelcomeTitle: "Te damos la bienvenida a RyzenStatus",
        ...
        obStepDoneBody: "RyzenStatus ya está cuidando de tu Mac.",
        ...
        obLanguageUpdateBody: "RyzenStatus ahora habla varios idiomas. Elige el que quieras usar; puedes cambiarlo cuando quieras en Ajustes.",
        ...
        processListRefreshIntervalLabel: "Refresco de lista de procesos",
        ...
        cleaningNeedsAxBody: "Para bloquear el teclado de forma segura, RyzenStatus necesita el permiso de Accesibilidad. Concédelo en Ajustes del Sistema e inténtalo de nuevo.",
        ...
        donateHeading: "Apoya a RyzenStatus",
        ...
        supportIntroTitle: "RyzenStatus es 100% gratis y siempre lo será",
        ...
        communityIntroFollowButton: "Seguir a @ryzenstatus en X",
        homebrewOfficialIntroTitle: "Ahora en el catálogo oficial de Homebrew",
        homebrewOfficialIntroMessage: "RyzenStatus ya se puede instalar directamente desde el catálogo oficial de Homebrew.",
        ...
        showMenuBarIconCaption: "Si el icono de RyzenStatus desaparece (macOS puede ocultar iconos de la barra de menús cuando se queda sin espacio, algo habitual en Macs con notch), vuelve a abrir RyzenStatus desde Aplicaciones o Spotlight: eso recrea el icono y, si sigue oculto, abre esta ventana. El botón de arriba hace lo mismo cuando ya puedes llegar hasta aquí. Mantener menos iconos en la barra de menús, o menos métricas en RyzenStatus, lo hace mucho menos probable.",
        ...
        menuBarIconManagerHintFormat: "%@ está abierto y puede estar guardando el icono en su sección oculta. Busca RyzenStatus ahí, o configura %@ para mostrar siempre RyzenStatus.",
        ...
        cleanerNotifDenied: "Las notificaciones de RyzenStatus están desactivadas en el sistema.",
        cleanerNotifOpenSettings: "Abrir ajustes de notificaciones…",
        launchAtLoginNeedsApplications: "La app se está ejecutando desde un lugar que no permite abrirse al iniciar sesión. Arrastra RyzenStatus a la carpeta Aplicaciones, ábrelo desde ahí y actívalo de nuevo.",
