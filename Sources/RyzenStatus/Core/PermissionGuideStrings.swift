...
extension PermissionGuideStrings {
    static let ko = PermissionGuideStrings(
        ...
        stepToggle: "그 목록에서 RyzenStatus를 켜세요.",
...
extension PermissionGuideStrings {
    static let enUS = PermissionGuideStrings(
        ...
        stepToggle: "Turn RyzenStatus on in that list.",
    ...
    static let ptBR = PermissionGuideStrings(
        ...
        stepToggle: "Ligue o RyzenStatus nessa lista.",
    ...
    static let tr = PermissionGuideStrings(
        ...
        stepToggle: "O listede RyzenStatus'i açın.",
    ...
    static let ru = PermissionGuideStrings(
        ...
        stepToggle: "Включите RyzenStatus в этом списке.",
    ...
    static let es = PermissionGuideStrings(
        ...
        stepToggle: "Activa RyzenStatus en esa lista.",
    ...
    static let de = PermissionGuideStrings(
        ...
        stepToggle: "Schalte RyzenStatus in dieser Liste ein.",
    ...
    static let fr = PermissionGuideStrings(
        ...
        stepToggle: "Activez RyzenStatus dans cette liste.",
    ...
    static let it = PermissionGuideStrings(
        ...
        stepToggle: "Attiva RyzenStatus in quell'elenco.",
    ...
    static let ja = PermissionGuideStrings(
        ...
        stepToggle: "そのリストでRyzenStatusをオンにしてください。",
