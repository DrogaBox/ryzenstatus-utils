...
struct FeatureHubStrings {
    ...
    let titleMouseButtons: String
    let titleSuperKey: String
    let descMouseButtons: String
    let descSuperKey: String
...
extension FeatureHubStrings {
    static let ko = FeatureHubStrings(
        ...
        explainFilesAndFolders: "정리기가 접근 권한이 필요한 파일과 폴더를 찾을 수 있게 합니다.",
        ...
        descNowPlaying: "현재 곡을 메뉴 막대에 표시",
        ...
        titleMouseButtons: "마우스 버튼",
        titleSuperKey: "슈퍼 키",
        descMouseButtons: "프로그래밍 가능한 마우스 버튼",
        descSuperKey: "Caps Lock 키 리매핑",
        installButton: "설치",
        uninstallButton: "제거",
...
extension FeatureHubStrings {
    static let enUS = FeatureHubStrings(
        ...
        permFilesAndFolders: "Files and Folders",
        explainFilesAndFolders: "Lets the cleaner find files and folders that need permission to access.",
        ...
        descNowPlaying: "Show the current track in the menu bar",
        ...
        titleMouseButtons: "Mouse Buttons",
        titleSuperKey: "Super Key",
        descMouseButtons: "Programmable mouse buttons",
        descSuperKey: "Caps Lock remapping",
    ...
    static let ptBR = FeatureHubStrings(
        ...
        explainFilesAndFolders: "Permite que o limpador encontre arquivos e pastas que precisam de permissão para acessar.",
        ...
        descNowPlaying: "Mostra a faixa atual na barra de menus",
        ...
        titleMouseButtons: "Botões do mouse",
        titleSuperKey: "Tecla super",
        descMouseButtons: "Botões de mouse programáveis",
        descSuperKey: "Remapeamento de Caps Lock",
    ...
    static let tr = FeatureHubStrings(
        ...
        explainFilesAndFolders: "Temizleyicinin erişim izni gerektiren dosya ve klasörleri bulmasını sağlar.",
        ...
        descNowPlaying: "Çalan parçayı menü çubuğunda gösterir",
        ...
        titleMouseButtons: "Fare düğmeleri",
        titleSuperKey: "Süper tuş",
        descMouseButtons: "Programlanabilir fare düğmeleri",
        descSuperKey: "Caps Lock yeniden eşleme",
        installButton: "Yükle",
    ...
    static let ru = FeatureHubStrings(
        ...
        explainFilesAndFolders: "Позволяет очистке находить файлы и папки, требующие разрешения.",
        ...
        descNowPlaying: "Показывает текущий трек в строке меню",
        ...
        titleMouseButtons: "Кнопки мыши",
        titleSuperKey: "Суперклавиша",
        descMouseButtons: "Программируемые кнопки мыши",
        descSuperKey: "Переназначение Caps Lock",
    ...
    static let es = FeatureHubStrings(
        ...
        titleNowPlaying: "En reproducción",
        ...
        explainFilesAndFolders: "Permite que el limpiador encuentre archivos y carpetas que requieren permiso.",
        ...
        descNowPlaying: "Muestra la canción actual en la barra de menús",
        ...
        titleMouseButtons: "Botones del ratón",
        titleSuperKey: "Tecla súper",
        descMouseButtons: "Botones de ratón programables",
        descSuperKey: "Remapeo de Bloq Mayús",
        installButton: "Instalar",
        uninstallButton: "Desinstalar",
    ...
    static let de = FeatureHubStrings(
        ...
        titleNowPlaying: "Aktueller Titel",
        ...
        permAutomationTerminal: "Terminal-Automation",
        permAudioCapture: "App-Audio",
        permFilesAndFolders: "Dateien und Ordner",
        explainFilesAndFolders: "Ermöglicht dem Reiniger, Dateien und Ordner zu finden, die Berechtigungen benötigen.",
        ...
        descNowPlaying: "Zeigt den aktuellen Titel in der Menüleiste an",
        ...
        titleMouseButtons: "Maustasten",
        titleSuperKey: "Supertaste",
        descMouseButtons: "Programmierbare Maustasten",
        descSuperKey: "Feststelltaste umbelegen",
    ...
    static let fr = FeatureHubStrings(
        ...
        titleNowPlaying: "En cours de lecture",
        ...
        explainFilesAndFolders: "Permet au nettoyeur de trouver les fichiers et dossiers nécessitant une autorisation.",
        ...
        descNowPlaying: "Affiche le morceau en cours dans la barre des menus",
        ...
        titleMouseButtons: "Boutons de la souris",
        titleSuperKey: "Touche super",
        descMouseButtons: "Boutons de souris programmables",
        descSuperKey: "Remappage de Verr. Maj",
    ...
    static let it = FeatureHubStrings(
        ...
        titleNowPlaying: "In riproduzione",
        ...
        explainFilesAndFolders: "Permette alla pulizia di trovare file e cartelle che richiedono autorizzazione.",
        ...
        descNowPlaying: "Mostra il brano in corso nella barra dei menu",
        ...
        titleMouseButtons: "Pulsanti del mouse",
        titleSuperKey: "Tasto super",
        descMouseButtons: "Pulsanti mouse programmabili",
        descSuperKey: "Rimappatura Blocco Maiuscole",
    ...
    static let ja = FeatureHubStrings(
        ...
        explainFilesAndFolders: "クリーナーがアクセス権限が必要なファイルやフォルダを見つけられるようにします。",
        ...
        titleMouseButtons: "マウスボタン",
        titleSuperKey: "スーパーキー",
        descMouseButtons: "プログラム可能なマウスボタン",
        descSuperKey: "Caps Lock の再マッピング",
    ...
    static let zhHans = FeatureHubStrings(
        ...
        permFilesAndFolders: "文件和文件夹",
        explainFilesAndFolders: "让清理器找到需要权限访问的文件和文件夹。",
        ...
        titleMouseButtons: "鼠标按键",
        titleSuperKey: "超级键",
        descMouseButtons: "可编程鼠标按键",
        descSuperKey: "大写锁定键重映射",
        installButton: "安装",
        uninstallButton: "卸载",
    ...
    static let zhTW = FeatureHubStrings(
        ...
        explainFilesAndFolders: "讓清理器找到需要權限存取的檔案與資料夾。",
        ...
        titleMouseButtons: "滑鼠按鍵",
        titleSuperKey: "超級鍵",
        descMouseButtons: "可編程滑鼠按鍵",
        descSuperKey: "大寫鎖定鍵重新映射",
        installButton: "安裝",
