...
extension WhatsAppOrganizerStrings {
    static let enUS = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp may download a moved file again. RyzenStatus cannot prevent the network download, but it can detect and discard an identical extra copy.",
    ...
    static let es = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp puede volver a descargar un archivo movido. RyzenStatus no puede impedir esa descarga, pero sí detectar y descartar una nueva copia idéntica.",
    ...
    static let ptBR = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "O WhatsApp pode baixar novamente um arquivo movido. O RyzenStatus não impede o download, mas detecta e descarta uma nova cópia idêntica.",
    ...
    static let de = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp kann eine verschobene Datei erneut herunterladen. RyzenStatus kann den Netzwerk-Download nicht verhindern, aber eine identische zusätzliche Kopie erkennen und aussortieren.",
    ...
    static let fr = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp peut retélécharger un fichier déplacé. RyzenStatus ne peut pas empêcher le téléchargement réseau, mais peut détecter et écarter une copie supplémentaire identique.",
    ...
    static let it = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp può scaricare di nuovo un file spostato. RyzenStatus non può impedire il download di rete, ma può rilevare e scartare una copia aggiuntiva identica.",
    ...
    static let tr = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp taşınan bir dosyayı yeniden indirebilir. RyzenStatus ağ indirmesini engelleyemez, ancak birebir aynı fazladan kopyayı saptayıp ayıklayabilir.",
    ...
    static let ru = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp может снова загрузить перемещённый файл. RyzenStatus не может помешать сетевой загрузке, но распознаёт идентичную лишнюю копию и отсеивает её.",
    ...
    static let zhHans = WhatsAppOrganizerStrings(
        ...
        enabled: "自动整理",
        enabledCaption: "WhatsApp 可能会再次下载已移动的文件。RyzenStatus 无法阻止网络下载，但能识别并剔除完全相同的多余副本。",
        destination: "目标文件夹",
        chooseFolder: "选择…",
        useDefault: "使用 下载/WhatsApp",
        invalidDestination: "请选择除「下载」本身以外的文件夹。",
        organization: "文件夹结构",
        flat: "无子文件夹",
        byType: "按文件类型",
        byMonth: "按年月",
        delay: "移动前等待",
        minutesFormat: "%d 分钟",
        duplicateAction: "再次下载相同文件时",
        trashDuplicate: "将新副本移到废纸篓",
        keepBoth: "保留两个副本",
        replaceExisting: "替换已整理的副本",
        duplicateCaption: "重复文件由私有 SHA-256 摘要确认。在丢弃另一副本之前会重新检查已整理的副本。",
        organizeNow: "立即整理符合条件的文件",
        undo: "撤销上次整理",
        waiting: "正在监视下载",
        working: "正在整理 WhatsApp 文件…",
        resultFormat: "已移动 %1$d · 重复 %2$d · 失败 %3$d",
        lastRunFormat: "上次整理 %@：已移动 %d · 重复 %d · 失败 %d",
        neverRun: "尚未运行整理。",
        notificationTitle: "WhatsApp 整理",
        notificationFormat: "已整理 %1$d 个文件。处理了 %2$d 个重复下载。%3$d 个失败。",
        privacyNote: "为识别完全相同的重复文件，文件字节仅在计算加密摘要时在本地读取。内容和聊天绝不会被存储或上传。"
    )

    static let zhTW = WhatsAppOrganizerStrings(
        title: "自動整理",
        experimental: "實驗性",
        description: "將穩定的 WhatsApp 下載移動到專用資料夾，並識別完全相同的重複下載。",
        enabled: "自動整理",
        enabledCaption: "WhatsApp 可能會再次下載已移動的檔案。RyzenStatus 無法阻止網路下載，但能識別並剔除完全相同的多餘副本。",
        destination: "目標資料夾",
        chooseFolder: "選擇…",
        useDefault: "使用 下載/WhatsApp",
        invalidDestination: "請選擇「下載」本身以外的資料夾。",
        organization: "資料夾結構",
        flat: "無子資料夾",
        byType: "按檔案類型",
        byMonth: "按年月",
        delay: "移動前等待",
        minutesFormat: "%d 分鐘",
        duplicateAction: "再次下載相同檔案時",
        trashDuplicate: "將新副本移到垃圾桶",
        keepBoth: "保留兩個副本",
        replaceExisting: "替換已整理的副本",
        duplicateCaption: "重複檔案由私有 SHA-256 摘要確認。在丟棄另一副本之前會重新檢查已整理的副本。",
        organizeNow: "立即整理符合條件的檔案",
        undo: "還原上次整理",
        waiting: "正在監視下載項目",
        working: "正在整理 WhatsApp 檔案…",
        resultFormat: "已移動 %1$d · 重複 %2$d · 失敗 %3$d",
        lastRunFormat: "上次整理 %@：已移動 %d · 重複 %d · 失敗 %d",
        neverRun: "尚未執行整理。",
        notificationTitle: "WhatsApp 整理",
        notificationFormat: "已整理 %1$d 個檔案。處理了 %2$d 個重複下載。%3$d 個失敗。",
        privacyNote: "為識別完全相同的重複檔案，檔案位元組僅在計算加密摘要時在本地讀取。內容和對話絕不會被儲存或上傳。"
    )

    static let zhHK = WhatsAppOrganizerStrings(
        title: "自動整理",
        experimental: "實驗性",
        description: "將穩定嘅 WhatsApp 下載移動到專用資料夾，並識別完全一樣嘅重複下載。",
        enabled: "自動整理",
        enabledCaption: "WhatsApp 可能會再次下載已經移動咗嘅檔案。RyzenStatus 冇得阻止網絡下載，但可以識別並剔除完全一樣嘅多餘副本。",
        destination: "目標資料夾",
        chooseFolder: "選擇…",
        useDefault: "用 下載/WhatsApp",
        invalidDestination: "請選擇「下載」以外嘅資料夾。",
        organization: "資料夾結構",
        flat: "冇子資料夾",
        byType: "按檔案類型",
        byMonth: "按年同月",
        ...
        trashDuplicate: "將新副本移到垃圾桶",
        keepBoth: "保留兩個副本",
        replaceExisting: "取代已整理嘅副本",
        duplicateCaption: "重複檔案由私有 SHA-256 摘要確認。喺丟棄另一副本之前會重新檢查已整理嘅副本。",
        organizeNow: "立即整理符合條件嘅檔案",
        undo: "還原上次整理",
        waiting: "正在監視下載項目",
        working: "正在整理 WhatsApp 檔案…",
        resultFormat: "已移動 %1$d · 重複 %2$d · 失敗 %3$d",
        ...
        neverRun: "尚未執行整理。",
        notificationTitle: "WhatsApp 整理",
        notificationFormat: "已整理 %1$d 個檔案。處理咗 %2$d 個重複下載。%3$d 個失敗。",
        privacyNote: "為咗識別完全一樣嘅重複檔案，檔案位元組只會喺計算加密摘要時喺本地讀取。內容同對話永遠唔會儲存或上載。"
    )
}
