...
extension MouseButtonFeatureStrings {
    static let enUS = MouseButtonFeatureStrings(
        ...
        captureBlind: "RyzenStatus cannot watch the mouse right now.",
    ...
    static let ptBR = MouseButtonFeatureStrings(
        ...
        captureBlind: "O RyzenStatus não consegue observar o mouse agora.",
    ...
    static let tr = MouseButtonFeatureStrings(
        ...
        captureBlind: "RyzenStatus şu anda fareyi izleyemiyor.",
    ...
    static let ru = MouseButtonFeatureStrings(
        ...
        captureBlind: "RyzenStatus сейчас не может отслеживать мышь.",
    ...
    static let es = MouseButtonFeatureStrings(
        ...
        captureCancel: "Cancelar",
        captureBlind: "RyzenStatus no puede observar el ratón ahora mismo.",
    ...
    static let de = MouseButtonFeatureStrings(
        ...
        captureBlind: "RyzenStatus kann die Maus gerade nicht beobachten.",
    ...
    static let fr = MouseButtonFeatureStrings(
        ...
        captureBlind: "RyzenStatus ne peut pas observer la souris pour le moment.",
    ...
    static let it = MouseButtonFeatureStrings(
        ...
        captureBlind: "RyzenStatus al momento non riesce a osservare il mouse.",
    ...
    static let ja = MouseButtonFeatureStrings(
        ...
        captureCancel: "キャンセル",
        captureBlind: "RyzenStatusは今マウスを監視できません。",
    ...
    static let ko = MouseButtonFeatureStrings(
        ...
        captureCancel: "취소",
        captureBlind: "RyzenStatus가 지금은 마우스를 지켜볼 수 없습니다.",
    ...
    static let zhHans = MouseButtonFeatureStrings(
        ...
        captureCancel: "取消",
        captureBlind: "RyzenStatus 目前无法监视鼠标。",
    ...
    static let zhTW = MouseButtonFeatureStrings(
        ...
        captureCancel: "取消",
        captureBlind: "RyzenStatus 目前無法監看滑鼠。",
