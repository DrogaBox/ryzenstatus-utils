...
extension Notification.Name {
    static let menuPanelWillShow = Notification.Name("RyzenStatusMenuPanelWillShow")
}
...
struct MenuPanelView: View {
    ...
    private func section(for id: PanelSectionID, collapsible: Bool = true) -> some View {
        ...
        case .amdPower: if showAmdPower { AmdControlSection(collapsible: collapsible) }
...
struct UtilitiesSection: View {
    ...
    private var isHostingUtility: Bool {
        showUninstaller || showCleanerPanel || showURLCleaner || showHomebrewPanel
            || showAppUpdatesPanel || showMediaPanel || showClipboardPanel || showWindowLayoutPanel
    }
