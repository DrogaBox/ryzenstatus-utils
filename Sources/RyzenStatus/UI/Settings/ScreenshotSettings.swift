...
struct ScreenshotSettings: View {
    ...
    @AppStorage(DefaultsKey.screenshotHideRyzenStatusWindows) private var hideRyzenStatusWindows = true
        ...
        Form {
            ...
            Section {
                ...
                Text(strings.freezeCaption)
                    .font(.caption)
                    .foregroundStyle(.secondary)
                Toggle(strings.hideRyzenStatusWindowsToggle, isOn: $hideRyzenStatusWindows)
