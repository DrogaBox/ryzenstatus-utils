...
final class ScreenshotSelectionController {
    ...
    private let hideRyzenStatusWindows: Bool
    ...
    init(freeze: Bool,
         includePointer: Bool,
         showLastRegion: Bool,
         hideRyzenStatusWindows: Bool = true,
        ...
        self.hideRyzenStatusWindows = hideRyzenStatusWindows
        ...
        if freeze {
            Task { @MainActor [weak self] in
                ...
                let images = await ScreenshotCaptureEngine.captureAllDisplays(
                    ...
                    hideRyzenStatusWindows: self.hideRyzenStatusWindows,
    ...
    private func present(frozenImages: [CGDirectDisplayID: CGImage]) {
        ...
        let pickable = ScreenshotCaptureEngine.pickableWindows(
            hideRyzenStatusWindows: hideRyzenStatusWindows,
    ...
    private func loadLiveLoupeImages() {
        let hideWindows = hideRyzenStatusWindows
        let excludedIDs = captureExcludedWindowIDs
        Task { @MainActor [weak self] in
            let images = await ScreenshotCaptureEngine.captureAllDisplays(
                includePointer: false,
                hideRyzenStatusWindows: hideWindows,
