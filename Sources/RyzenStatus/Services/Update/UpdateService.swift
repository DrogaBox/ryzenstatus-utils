...
final class UpdateService: ObservableObject {
    ...
    private static let versionTrimmingCharacterSet = CharacterSet(charactersIn: "vV ")
    ...
    private func evaluateLatestRelease(data: Data) {
        ...
        let latest = release.tagName.trimmingCharacters(in: Self.versionTrimmingCharacterSet)
    ...
    private func evaluateReleases(data: Data) {
        ...
        for release in releases {
            let tag = release.tagName.trimmingCharacters(in: Self.versionTrimmingCharacterSet)
