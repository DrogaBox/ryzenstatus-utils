...
final class UpdateService: ObservableObject {
    ...
    private static let versionTrimCharacterSet = CharacterSet(charactersIn: "vV ")
    ...
    private func evaluateLatestRelease(data: Data) {
        ...
        let latest = release.tagName.trimmingCharacters(in: Self.versionTrimCharacterSet)
    ...
    private func evaluateReleases(data: Data) {
        ...
        for release in releases {
            let tag = release.tagName.trimmingCharacters(in: Self.versionTrimCharacterSet)
