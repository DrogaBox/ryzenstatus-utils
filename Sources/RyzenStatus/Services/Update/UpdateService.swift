...
final class UpdateService: ObservableObject {
    ...
    // Cache CharacterSet to avoid allocations during iteration
    private static let versionPrefixCharacterSet = CharacterSet(charactersIn: "vV ")
    ...
    private func evaluateLatestRelease(data: Data) {
        ...
        let latest = release.tagName.trimmingCharacters(in: Self.versionPrefixCharacterSet)
    ...
    private func evaluateReleases(data: Data) {
        ...
        for release in releases {
            let tag = release.tagName.trimmingCharacters(in: Self.versionPrefixCharacterSet)
