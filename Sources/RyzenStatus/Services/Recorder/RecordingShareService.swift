...
final class RecordingShareService: ObservableObject {
...
#endif
        return RecordingSharingSupport.endpoint(
    ...
    func createLink(artifact: RecorderExporter.ShareArtifact,
        ...
        // No developer-configured endpoint (the shipped app never has one):
        // sharing is unavailable rather than uploading to an unowned host.
        guard let serviceEndpoint = endpoint else {
            throw RecordingShareError.unavailable
        }
