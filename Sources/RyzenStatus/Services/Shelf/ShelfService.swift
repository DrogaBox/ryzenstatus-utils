...
final class ShelfService: ObservableObject {
    ...
    private let tempDir: URL = {
        let id = Bundle.main.bundleIdentifier ?? "com.ryzenstatus.utils"
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("RyzenStatusShelf", isDirectory: true)
    ...
    private static let persistQueue = DispatchQueue(label: "com.ryzenstatus.utils.shelf-persist",
                                                    qos: .utility)
