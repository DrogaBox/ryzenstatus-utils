...
| F-22k | Manual-mode fan slider stops tracking real PWM | **OPEN — app-side** | Kext case 94 exposes throttle+mode (`UserClient.cpp:1187-1231`); app gap tracked as C-6 prerequisite; fix in `FanCurveController` polling of selector 94 |
