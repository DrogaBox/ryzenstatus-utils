...
The GPL license does not grant permission to use the RyzenStatus name, logo, icon,
bundle identity, trade dress, official branding, or any signing identity
controlled by the project maintainer.

Official RyzenStatus builds are distributed only by the project maintainer.
...
Do not present a modified build as RyzenStatus or as an official release unless
